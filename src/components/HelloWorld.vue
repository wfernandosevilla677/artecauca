...
<section > 
    <br>
    <br> 
 <img alt="logo prin" src="../assets/Logo/Isotipo.png"/>

</section>
<img class="frase" src="../assets/Logo/frase.png" alt="">
<img class="volcan" src="../assets/Logo/vol.png" alt="" >
...
body{
    background-image: url(/Imágenes/Logo/fondo.png);
